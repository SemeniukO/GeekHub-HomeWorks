...
export class Animal {
    constructor(htmlMatrix, timerId, name) {
        ...
        this.stepCounter = 0;
        insertDom(this.name, this.deerBarS, this.deerBarH,this.steps);
    ...
    health() {
        let Satiety = document.querySelector('#' + this.deerBarS);
        let Health = document.querySelector('#' + this.deerBarH);
